...
<div id="footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="mc_embed_signup">
                        <form action="https://thebisoft.us19.list-manage.com/subscribe/post?u=91c449016641a5ef42b82d70b&id=67c7d91b3b"
                            ...
                            <div id="mc_embed_signup_scroll">
                                ...
                                <button type="submit" value="Đăng ký" name="subscribe" id="mc-embedded-subscribe"
                                        class="button">Đăng ký
                                </button>
                                <div class="info"></div>
                            </div>
                        </form>
    ...
    <!-- Modal Register Now -->
    <div class="modal fade modal-register-now" id="modalRegisterNow" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">Đăng ký học ngay</h4>

                    <p class="sub-title">
                        Đăng ký học gia sư ngay để mang lại một kết quả chất lượng nhất
                    </p>

                    <div class="from-register-now">
                        <?php echo do_shortcode('[contact-form-7 id="845" title="Form đăng kí học"]'); ?>
                    </div>

                    <div class="note text-center">
                        <p>Hoặc liên hệ với Hotline</p>

                        <p>
                            <a href="tel:0911321300">0911 321 300</a> (Thiết kế) <a href="tel:0975458209">0975 458 209</a> (Code)
                        </p>

                        <p>để được tư vấn khóa học phù hợp với bạn</p>
                    </div>
                </div>
            </div>
        </div>
